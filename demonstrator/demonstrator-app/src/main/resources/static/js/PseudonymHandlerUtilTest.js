...
QUnit.module('updateMDAT', () => {
    ...
    QUnit.test('Update CREATED', assert => {
        ...
        pseudonymHandler.updateMDAT(patient, mdat);
...
QUnit.module('getPatients', hooks => {
    ...
    QUnit.test('Find one status', assert => {
        ...
        const result = pseudonymHandler.getPatients(patients, PatientStatus.PSEUDONYMIZED);
    ...
    QUnit.test('Find multiple status', assert => {
        ...
        const result = pseudonymHandler.getPatients(patients, [PatientStatus.PSEUDONYMIZED, PatientStatus.IDAT_CONFLICT]);
    ...
    QUnit.test('Find multiple status from subset', assert => {
        ...
        const result = pseudonymHandler.getPatients(patients, [PatientStatus.PSEUDONYMIZED, PatientStatus.IDAT_CONFLICT], [0, 3]);
